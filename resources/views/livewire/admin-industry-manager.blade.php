        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr style="background: #f7fafc; border-bottom: 2px solid #e2e8f0;">
                    ...
                    <th style="padding: 1rem; text-align: left; font-weight: 600; color: #2d3748;">Industry Name</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #e2e8f0; transition: background 0.2s;">
                    <td style="padding: 1rem;">
                        <span style="color: #718096; font-size: 0.9rem;">#{{ $industry->id }}</span>
                    </td>
                    <td style="padding: 1rem;">
                        <span style="font-weight: 500; color: #2d3748;">{{ $industry->name }}</span>
                    </td>
                    <td style="padding: 1rem; text-align: right;">
                        <button wire:click="edit({{ $industry->id }})" style="background: #edf2f7; color: #2d3748; border: 1px solid #cbd5e0; padding: 0.5rem 0.75rem; border-radius: 4px; cursor: pointer; margin-right: 0.5rem; font-size: 0.9rem;">
                            <i class="fas fa-edit"></i> Edit
                        </button>
                        <button wire:click="delete({{ $industry->id }})" style="background: #fed7d7; color: #c53030; border: 1px solid #fc8181; padding: 0.5rem 0.75rem; border-radius: 4px; cursor: pointer; font-size: 0.9rem;">
    ...
    <div class="modal-overlay" @if ($showModal) style="display: flex;" @endif>
        <div class="modal-content" style="max-width: 400px;">
            <div class="modal-header">
                <h3>{{ $editingId ? 'Edit Industry' : 'Add New Industry' }}</h3>
