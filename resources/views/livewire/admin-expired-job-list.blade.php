        ...
        <div class="modal-content" style="max-width: 680px; max-height: 90vh; overflow-y: auto;">
            ...
            <div style="padding: 1.5rem 2rem;">
                ...
                <div class="jb-tags" style="margin-bottom:1.25rem;">
                    ...
                    <span class="job-status status-expired">Expired</span>
                </div>
                ...
                <div class="jb-details" style="margin-bottom:1.25rem;">
                    ...
                    <div class="jb-detail"><span>📊</span>
                        <div><strong>Applicants:</strong> {{ $viewingJob->applicants->count() }}</div>
                    </div>
                    <div class="jb-detail"><span>👤</span>
            ...
            <div class="modal-footer" style="padding: 0 1rem 1rem 1rem; gap: 0.75rem;">
                <button type="button" class="btn btn-sm" wire:click="editJob('{{ $viewingJob->id }}')" style="background:#10b981; color:#fff; border:none; padding:0.5rem 1rem; border-radius:6px;">
    ...
    <div class="jb-grid">
        ...
        <div class="jb-card" data-country="{{ $country }}" data-type="{{ $job->type }}">
            <div class="jb-card-header">
                ...
                <span class="job-status status-expired" style="margin-left:auto; white-space:nowrap;">
                    Expired
                </span>
            </div>
            ...
            <div class="jb-card-body">
                ...
                <div class="jb-details">
                    ...
                    <div class="jb-detail jb-detail-full">
                        <span>💰</span>
                        <div><strong>Salary:</strong> {{ $job->currency }} {{ number_format($job->salary_min) }} – {{ $job->currency }} {{ number_format($job->salary_max) }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="jb-card-footer">
                <span>Expired {{ $job->closing_date ? $job->closing_date->format('M d, Y') : 'N/A' }}</span>
        ...
        <div style="grid-column: 1 / -1; text-align: center; padding: 3rem; color: #718096;">
            <i class="fas fa-archive" style="font-size: 3rem; margin-bottom: 1rem; display: block;"></i>
